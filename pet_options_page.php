<div id="content">
	<div class="ada-admin">
      ...
      <h2><span class="pet-header"></span><?php _e('Options & About','wp_pet');?></h2>
        ...
        <input type="image" src="https://p.simg.uol.com.br/out/pagseguro/i/botoes/doacoes/180x25-doar-cinza.gif" name="submit" alt="Pague com PagSeguro - � r�pido, gr�tis e seguro!" />
        </form>
        </div>
